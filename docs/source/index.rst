...
.. raw:: html
   ...
   <img class="theme-light-only" src="_static/solphin_transparent.png" alt="solphin logo">
   <img class="theme-dark-only" src="_static/solphin_white.png" style="display:none;" alt="solphin logo">
...
.. raw:: html
   ...
   <img class="theme-light-only" src="_static/solphin_workflow_light.png"
   ...
   <img class="theme-dark-only" src="_static/solphin_workflow_dark.png"
        alt="Flowchart of the solphin workflow, from crystal structure through
        VASP or CASTEP calculations to the efficiency analysis"
        style="display:none;">
